...
class DishOrderCell: UICollectionViewCell {
    ...
    private func setupMainLabel() {
        ...
        mainLabel.heightAnchor.constraint(equalToConstant: 18).isActive = true
    }
    ...
    private func setupDetailLabel() {
        ...
        detailLabel.bottomAnchor.constraint(equalTo: priceLabel.topAnchor, constant: -2).isActive = true
    }
